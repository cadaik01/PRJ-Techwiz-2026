...
| A3 | Quản lý khách hàng | AD-09 → 13 (khóa → T5/T6/T13 qua lõi FSM, hoàn kho như A2; lưu / xóa `deactivation_reason`, D-024; **cờ `at_risk` / `no_show_count` chỉ đếm `NO_SHOW` qua T11, không đếm T14 + bộ lọc (D-028, D-036)**) | A-04 (cột Lý do khóa, badge At risk) | TB |
