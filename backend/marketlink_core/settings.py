...
MIDDLEWARE = [
    # First, so every response and log line carries X-Request-ID.
...
REST_FRAMEWORK = {
    ...
    # Envelope + error catalog (Pass 4B §2.1, §2.5) and page numbers in `data` (§2.2).
    "EXCEPTION_HANDLER": "marketlink_core.utils.custom_exception_handler",
    "DEFAULT_PAGINATION_CLASS": "marketlink_core.pagination.ContractPagination",
    "PAGE_SIZE": 20,
