...
│   ├── ui/                          # UI Primitives tự bọc Radix Headless + Tailwind (Thay thế shadcn)
...
│   └── utils.js                     # Hàm cn() nối class (clsx + tailwind-merge)
│
...
```json
{
  ...
  "dependencies": {
    ...
    "clsx": "^2.1.1",                      // Tiện ích kết hợp điều kiện class CSS linh hoạt
    "tailwind-merge": "^3.6.0",            // Xử lý xung đột class Tailwind khi bọc components (hàm cn)
  ...
  "devDependencies": {
    ...
    "@tailwindcss/vite": "^4.3.3",         // Plugin tích hợp Tailwind v4 trực tiếp vào Vite
...
### 3. NĂM LƯU Ý KỸ THUẬT CỐT LÕI TẦNG FRONTEND REACT
