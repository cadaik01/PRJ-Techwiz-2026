export const QUERY_KEYS = {
  ...
  ADMIN_FARMER_IMPACT: (id                 ) =>
    ['admin-farmer-impact', String(id)]         ,
  ADMIN_CUSTOMERS: (params          ) => ['admin-customers', params]         ,
  ADMIN_CUSTOMER_IMPACT: (id                 ) =>
    ['admin-customer-impact', String(id)]         ,
  ADMIN_CUSTOMER: (id        ) => ['admin-customer', id]         ,
  ADMIN_MARKETS: (params          ) => ['admin-markets', params]         ,
  ADMIN_MARKET_CLOSURES: (marketId        ) =>
    ['admin-market-closures', marketId]         ,
