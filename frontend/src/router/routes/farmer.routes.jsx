...
const FarmerStockTemplatePage = lazy(() => import('@/pages/farmer/FarmerStockTemplatePage'));
...
const FarmerNotificationsPage = lazy(() => import('@/pages/farmer/FarmerNotificationsPage'));
