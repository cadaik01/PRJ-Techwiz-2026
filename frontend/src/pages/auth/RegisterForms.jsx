...
import { registerCustomerSchema, registerFarmerSchema } from '@/features/auth/schemas/auth.schemas';
...
function AuthFooter({ prompt, linkTo, linkLabel, }) {
    return (<p className="register-form__footer">
      {prompt}{' '}
...
export function RegisterCustomerForm() {
    ...
    return (<div className="register-form">
      ...
      <form className="register-form__form" onSubmit={handleSubmit(async (values) => {
            try {
        ...
        <div className="register-form__field">
          ...
          {errors.full_name ? (<p className="register-form__error">{errors.full_name.message}</p>) : null}
        </div>
        <div className="register-form__field">
          <Input id="email" type="email" label="Email" {...register('email')}/>
          {errors.email ? (<p className="register-form__error">{errors.email.message}</p>) : null}
        </div>
        <div className="register-form__field">
          <Input id="phone" label="Phone number" {...register('phone')}/>
          {errors.phone ? (<p className="register-form__error">{errors.phone.message}</p>) : null}
        </div>
        <div className="register-form__field">
          <Input id="address" label="Address" {...register('address')}/>
          {errors.address ? (<p className="register-form__error">{errors.address.message}</p>) : null}
        </div>
        <div className="register-form__field">
          <Input id="password" type="password" label="Password" {...register('password')}/>
          {errors.password ? (<p className="register-form__error">{errors.password.message}</p>) : null}
        </div>
        <div className="register-form__field">
          <Input id="confirm_password" type="password" label="Confirm password" {...register('confirm_password')}/>
          {errors.confirm_password ? (<p className="register-form__error">{errors.confirm_password.message}</p>) : null}
        </div>
        <Button type="submit" size="lg" className="register-form__submit" loading={registerCustomerPending}>
          Create my account
        </Button>
      </form>
...
export function RegisterFarmerForm() {
    ...
    return (<div className="register-form">
      <div>
        ...
        <p className="register-form__subtitle">
          Set up your profile â€” once approved, customers can pre-order from you
          on MarketLink.
        </p>
      ...
      <form className="register-form__form" onSubmit={handleSubmit(async (values) => {
        ...
        {step === 1 ? (<>
            ...
            <Button type="button" size="lg" className="register-form__submit" onClick={async () => {
            ...
            <div className="register-form__field">
              ...
              {errors.stall_name ? (<p className="register-form__error">{errors.stall_name.message}</p>) : null}
            </div>
            <div className="register-form__field">
              <Input id="contact_person" label="Contact person" {...register('contact_person')}/>
              {errors.contact_person ? (<p className="register-form__error">{errors.contact_person.message}</p>) : null}
            </div>
            <div className="register-form__field">
              <Input id="address" label="Address" {...register('address')}/>
              {errors.address ? (<p className="register-form__error">{errors.address.message}</p>) : null}
            ...
            <div className="register-form__submit-row">
              ...
              <Button type="submit" size="lg" className="register-form__submit" loading={registerFarmerPending}>
                Submit for review
              </Button>
            </div>
          </>)}
