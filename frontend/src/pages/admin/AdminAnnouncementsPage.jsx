...
import { useAdminAnnouncements, useCreateAnnouncement, useDeleteAnnouncement, useToggleAnnouncement } from '@/features/admin/hooks/useAdminAnnouncements';
import { announcementSchema } from '@/features/admin/schemas/announcement.schema';
...
export default function AdminAnnouncementsPage() {
    ...
    return (<div className="admin-announcements-page">
      <PageHeader eyebrow="Broadcasts" title="Announcements" description="Publish banners by audience and schedule when they appear."/>
      ...
      <form className="admin-announcements-page__create" onSubmit={form.handleSubmit(onSubmit)}>
        ...
        <div className="page-primitive__form-field">
          ...
          {form.formState.errors.content ? (<p className="page-primitive__error">
        ...
        <div className="page-primitive__toolbar">
          ...
          <Input type="datetime-local" label="Starts at" className="page-primitive__input-auto" {...form.register('starts_at')}/>
        ...
        {form.formState.errors.starts_at ? (<p className="page-primitive__error">
            {form.formState.errors.starts_at.message}
          </p>) : null}
      </form>

      {query.isLoading ? (<PageSkeleton />) : !query.data?.results.length ? (<EmptyState title="No announcements yet" description="Create a banner when you need to reach farmers or shoppers."/>) : (<ul className="admin-announcements-page__list">
          {query.data.results.map((announcement) => (<li key={announcement.id} className="admin-announcements-page__item">
