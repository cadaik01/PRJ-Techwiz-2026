    ...
    <div className='admin-farmer-detail-page'>
      ...
      <div className='page-primitive__stat-grid-3'>
        <Card>
          ...
          <CardContent className='page-primitive__stat-value'>{f.order_stats?.total ?? 0}</CardContent>
        </Card>
        <Card>
          <CardHeader className='page-primitive__card-header-tight'>
            <CardTitle className='page-primitive__card-title-muted'>Completed</CardTitle>
          </CardHeader>
          <CardContent className='page-primitive__stat-value'>{f.order_stats?.completed ?? 0}</CardContent>
        </Card>
        <Card>
          <CardHeader className='page-primitive__card-header-tight'>
            <CardTitle className='page-primitive__card-title-muted'>No-show</CardTitle>
          </CardHeader>
          <CardContent className='page-primitive__stat-value'>{f.order_stats?.no_show ?? 0}</CardContent>
        </Card>
      </div>
      ...
      <Card>
        ...
        <CardContent className='admin-farmer-detail-page__history'>
          {f.status_history?.map((h, index) => (
            <div key={`${h.changed_at}-${index}`} className='page-primitive__history-item'>
              <p className='page-primitive__font-medium'>
                
                {h.from_status ? `${farmerStatusLabel(h.from_status)} → ${farmerStatusLabel(h.to_status)}` : `Registered · ${farmerStatusLabel(h.to_status)}`}
              </p>
