...
import { AUDIT_ACTION_OPTIONS, auditActionLabel, auditActionTone, auditOutcome, auditReason, auditSubject } from "../../utils/auditLabels";
    ...
    <div className='admin-audit-logs-page'>
      ...
      <form
        ...
        <div className='admin-audit-logs-page__field'>
          <select id='audit-event' className='page-primitive__select' value={action} onChange={(e) => setAction(e.target.value)}>
        ...
        <Input type='date' label='From' value={from} onChange={(e) => setFrom(e.target.value)} className='page-primitive__input-auto' />
              ...
              <tbody>
                {query.data.results.map((log) => (
                  <tr key={log.id} className='page-primitive__table-row'>
                    <td className='page-primitive__table-td'>{formatDateTime(log.created_at)}</td>
                    <td className='page-primitive__table-td'>
                      <Badge variant={TONE_VARIANT[auditActionTone(log.action)] || "secondary"}>{auditActionLabel(log.action)}</Badge>
                    </td>
                    <td className='page-primitive__table-td'>
                      {log.user ? (
                        <button
