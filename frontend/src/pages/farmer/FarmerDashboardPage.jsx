...
export default function FarmerDashboardPage() {
    ...
    return (<div className="farmer-dashboard-page">
      <PageHeader eyebrow="Stall workspace" title="Stall overview" description={`${user?.display_name ?? 'Your stall'} — today's pickups, revenue, and what needs attention.`}/>

      <div className="page-primitive__toolbar">
        <Input id="from" type="date" label="From" value={from} onChange={(e) => setFrom(e.target.value)} className="page-primitive__input-auto"/>
        <Input id="to" type="date" label="To" value={to} onChange={(e) => setTo(e.target.value)} className="page-primitive__input-auto"/>
      </div>
      ...
      <div className="page-primitive__stat-grid-4">
