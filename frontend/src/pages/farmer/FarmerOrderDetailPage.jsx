...
export default function FarmerOrderDetailPage() {
    ...
    return (<div className="farmer-order-detail-page">
      <PageHeader eyebrow="Order" title={`#${order.id}`} description={`${order.customer.full_name} · ${order.customer.phone}`} actions={<>
