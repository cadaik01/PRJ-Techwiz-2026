...
export default function FarmerMarketsPage() {
    ...
    return (<div className="farmer-markets-page">
      <PageHeader eyebrow="Market sessions" title="Markets & pickup times" description="Join markets, set your stall label, and publish bookable pickup slots."/>
      ...
      <div className="page-primitive__layout-5">
        <div className="page-primitive__layout-5-side">
          ...
          <div className="page-primitive__dashed-panel">
            ...
            <Input label="Stall label (e.g. Aisle A · Stall 12)" value={stallLabel} onChange={(e) => setStallLabel(e.target.value)}/>
