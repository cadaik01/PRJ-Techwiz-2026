...
export default function FarmerDetailPage() {
  ...
  if (farmerQuery.isLoading) return <PageSkeleton />;
      ...
      <div className="farmer-detail-page__container">
        ...
        <div className="farmer-detail-page__badges">
          {farmer.markets.map((m) => (
            <Badge key={m.market_id} variant="secondary">
            ...
            {productsQuery.isLoading ? (
              <div className="farmer-detail-page__products-grid">
                {Array.from({ length: 3 }).map((_, i) => (
                  <Skeleton key={i} className="farmer-detail-page__product-skeleton" />
                ))}
              </div>
          ...
          <TabsContent value="about" className="farmer-detail-page__about-layout">
            <div className="farmer-detail-page__about-copy">
              ...
              <div className="farmer-detail-page__market-links">
                {farmer.markets.map((m) => (
                  <Button key={m.market_id} asChild variant="outline" size="sm">
            ...
            <div className="farmer-detail-page__about-map">
              {primaryWindow ? (
                <>
                  <Suspense
                    fallback={<Skeleton className="farmer-detail-page__map-skeleton" />}
                  >
                    <MiniMap
                  ...
                  <Button
                    asChild
                    className="farmer-detail-page__directions"
                    variant="outline"
                  >
                    <a
                      href={googleMapsDirectionsUrl(
                        primaryWindow.latitude,
                        primaryWindow.longitude,
                      )}
                      target="_blank"
                      rel="noreferrer"
                    >
                          ...
                          {dateOption.slots
                            ...
                            .map((slot) => (
                              <div
                                ...
                                className="farmer-detail-page__slot"
                              >
