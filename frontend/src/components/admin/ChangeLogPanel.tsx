...
import type { ChangeLogEntry, TrackedModel } from '@/types';

import './ChangeLogPanel.css';

const TYPE_LABEL: Record<ChangeLogEntry['change_type'], string> = {
  CREATED: 'Created',
  UPDATED: 'Edited',
  DELETED: 'Deleted',
};
...
export function ChangeLogPanel({ model, id }: { model: TrackedModel; id: number }) {
