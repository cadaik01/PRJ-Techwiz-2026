...
const ERROR_MAP = {
    ...
    FARMER_SUSPENDED: {
        ...
        suggestion: 'Contact the administrator to have the stall reinstated.',
    },
    FARMER_NOT_APPROVED: {
        title: 'Farmer profile is not approved yet',
        suggestion: 'Wait for the administrator to approve the stall before selling.',
    },
    CUTOFF_NOT_REACHED: {
    ...
    REPLY_ALREADY_EXISTS: {
        ...
        suggestion: 'Only one reply per review is allowed.',
    },
    RESOURCE_IN_USE: {
    ...
    INVALID_CREDENTIALS: {
        ...
        suggestion: 'Check both fields and try again.',
    },
    ACCOUNT_LOCKED: {
    ...
    PERMISSION_DENIED: {
        ...
        suggestion: 'Sign in with an account that has the right role.',
    },
    ACTION_NOT_PERMITTED_FOR_ROLE: {
        title: 'This action belongs to another role',
        suggestion: 'Only the farmer or the administrator can do this.',
    },
    NOT_FOUND: {
        title: 'Not found',
        suggestion: 'The item may have been removed, or it belongs to someone else.',
    },
    IDEMPOTENCY_KEY_REUSED: {
        title: 'The order details changed',
        suggestion: 'Send the order again to place it with the new details.',
    },
    FAILED_PRECONDITION: {
        title: 'This action is not possible right now',
        suggestion: 'Resolve what is pending on this record first.',
    },
    ...
    INTERNAL_SERVER_ERROR: {
        ...
        suggestion: 'Please try again; contact support if it keeps happening.',
    },
    AI_UNAVAILABLE: {
