    ...
    status_history: [
      {
        from_status: 'PENDING',
        to_status: status,
        reason: status === 'APPROVED' ? 'Hồ sơ hợp lệ' : null,
...
export let adminFarmers: AdminFarmerRecord[] = [
  ...
  baseFromSeed(seedFarmers[4], 'APPROVED', 'rau@demo.vn'),
  {
    ...
    product_count: 0,
    rating_avg: null,
    description: 'Trồng rau sạch khu Đông, muốn tham gia phiên chợ Thủ Đức.',
    image: null,
    markets: [],
    operating_days: [],
  ...
  },
  {
    ...
    product_count: 0,
    rating_avg: null,
    description: 'Dâu tây Đà Lạt nhà kính, giao quầy sáng sớm.',
    image: null,
    markets: [],
    operating_days: [],
    in_stock_product_count: 0,
...
export let auditLogs: AuditLogItem[] = [
  {
    ...
    status_code: 200,
    request_id: 'req-1',
    details: { stall_name: 'Shop Rau Đà Lạt' },
  ...
  },
  {
    ...
    status_code: 200,
    request_id: 'req-2',
    details: { reason: 'Nhiều lần no-show', no_show_count: 5 },
