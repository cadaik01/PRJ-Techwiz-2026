import { categories, farmers, markets, products, pickupOptions, reviews } from '@/mocks/catalog';
...
export let farmerProducts = products
    ...
    .map((p) => toFarmerProduct(p, p.id === 2 ? 4 : p.id === 4 ? 2 : 0, p.id === 2 ? 50 : p.id === 3 ? 70 : p.id === 4 ? 30 : 40));
