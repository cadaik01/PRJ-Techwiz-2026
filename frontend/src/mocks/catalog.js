...
const IMG = 'https://images.unsplash.com/photo-1555396273-367ea4eb4db5?auto=format&fit=crop&w=800&q=80';
const PRODUCT_IMG = 'https://images.unsplash.com/photo-1622206151226-18ca2c9ab4a1?auto=format&fit=crop&w=800&q=80';
const AVATAR = 'https://images.unsplash.com/photo-1594824476967-48c8b964273f?auto=format&fit=crop&w=200&q=80';
...
function buildPickupDates(marketId, marketName, stallLabel, latitude, longitude, slotIdBase) {
...
export const pickupOptions = {
    ...
    103: [
        buildPickupDates(3, 'Thu Duc Produce Market', 'Dairy row · Stall 07', 10.8503, 106.7718, 50),
    ],
