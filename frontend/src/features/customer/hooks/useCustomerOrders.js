...
export function useCancelOrder(orderId) {
    ...
    return useMutation({
        mutationFn: ({ reason, version }) => customerApi.cancelOrder(Number(orderId), reason, version),
        onSuccess: () => {
...
export function useUpdateOrder(orderId) {
    ...
    const id = String(orderId);
    return useMutation({
        mutationFn: ({ payload, version, }) => customerApi.updateOrder(Number(orderId), payload, version),
        onSuccess: () => {
