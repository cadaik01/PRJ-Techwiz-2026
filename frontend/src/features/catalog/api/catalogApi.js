...
import { adaptFarmerPage, adaptFarmerSummary, adaptMarketDetail, adaptMarketPage, adaptProductDetail, adaptProductPage } from '@/lib/adapters/catalog.adapter';
...
export const catalogApi = {
    ...
    getFarmerPickupOptions: async (id, opts) => {
        const { data } = await axiosClient.get(`/farmers/${id}/pickup-options/`, { params: toParams({ from: opts?.from, days: opts?.days }) });
